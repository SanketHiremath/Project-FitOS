...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_Screen1, &ui_img_pastel_purple_png, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Image2 = lv_img_create(ui_Screen1);
    lv_img_set_src(ui_Image2, &ui_img_ring_png);
    ...
    lv_img_set_src(ui_Image1, &ui_img_watch_hour_modern_png);
    ...
    lv_img_set_src(ui_Image3, &ui_img_watch_min_modern_png);
    ...
    lv_img_set_src(ui_Image4, &ui_img_watch_sec_modern_png);
    lv_obj_set_width(ui_Image4, LV_SIZE_CONTENT);   /// 50
    lv_obj_set_height(ui_Image4, LV_SIZE_CONTENT);    /// 450
    lv_obj_set_x(ui_Image4, 1);
    lv_obj_set_y(ui_Image4, 2);
    lv_obj_set_align(ui_Image4, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_Image4, LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    lv_obj_clear_flag(ui_Image4, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_img_set_angle(ui_Image4, 1060);
    ...
    lv_label_set_text(ui_Label2, "21");
    lv_obj_set_style_text_font(ui_Label2, &lv_font_montserrat_18, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_Label2, lv_color_hex(0xA34EB0), LV_PART_MAIN | LV_STATE_DEFAULT);
